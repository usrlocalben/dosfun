...
COMMON_FLAGS = -std=gnu++17
# COMMON_FLAGS = $(COMMON_FLAGS) -DSHOW_TIMING
COMMON_FLAGS := $(COMMON_FLAGS) -DVOLTABLE
COMMON_FLAGS := $(COMMON_FLAGS) -DMIX_SATURATE
# COMMON_FLAGS = $(COMMON_FLAGS) -DTTYCON
# COMMON_FLAGS = $(COMMON_FLAGS) -DEARLY_EOI
RELEASE_FLAGS = -O3 -ffast-math -DNDEBUG -march=i486
DEBUG_FLAGS = -g
